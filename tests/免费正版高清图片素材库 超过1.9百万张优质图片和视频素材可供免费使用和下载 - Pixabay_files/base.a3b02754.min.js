try {
  var jQuery = django.jQuery,
    ...
    LANG = 'en',
    LANG_URL_PREFIX = '',
    I18N = { delete: 'Really delete?' };
} catch (e) {}
var ua = navigator.userAgent.toLowerCase(),
  mobile_os =
    (/windows phone/.test(ua) ? 'Windows' : /android/.test(ua) && 'Android') ||
    (/ipad|iphone|ipod/.test(ua) && !window.MSStream && 'iOS') ||
    null,
  ...
  hover_media,
  hover_media_to,
  is_human = 'ontouchstart' in window;
...
!(function (e) {
  ...
  'function' == typeof define && define.amd
    ? define(['jquery'], e)
    : e(void 0 !== jQuery ? jQuery : window.Zepto);
})(function (e) {
  'use strict';
  function t(t) {
    var r = t.data;
  ...
  (e.fn.attr2 = function () {
    ...
    (e.fn.ajaxSubmit = function (t) {
      function s(r) {
        ...
        function o() {
          var r = f.attr2('target'),
            i = f.attr2('action'),
            c =
              f.attr('enctype') || f.attr('encoding') || 'multipart/form-data';
        ...
        function s(t) {
          if (!x.aborted && !F) {
            if (
              ((M = n(g)) || (a('cannot access response document'), (t = k)),
              t === D && x)
            )
        ...
        if (
          (((m = e.extend(!0, {}, e.ajaxSettings, t)).context = m.context || m),
          (p = 'jqFormIO' + new Date().getTime()),
          m.iframeTarget
            ? (b = (v = e(m.iframeTarget)).attr2('name'))
              ? (p = b)
              : v.attr2('name', p)
            : (v = e(
          ...
          (d = m.global) && 0 == e.active++ && e.event.trigger('ajaxStart'),
      ...
      if (
        ...
        t.beforeSubmit && !1 === t.beforeSubmit(v, this, t))
      )
    ...
    (e.fn.ajaxForm = function (n) {
      if (
        (((n = n || {}).delegation = n.delegation && e.isFunction(e.fn.on)),
      ...
      if (!G) {
        if (
          ...
          var h = a(_.get('initialWidth'), 'x'),
            ...
            l = _.get('maxWidth'),
            f = _.get('maxHeight');
          (_.w = Math.max((!1 !== l ? Math.min(h, a(l, 'x')) : h) - z - D, 0)),
            (_.h = Math.max(
              (!1 !== f ? Math.min(s, a(f, 'y')) : s) - N - j,
              0
            )),
                  ...
                  ? ('string' == typeof _.get('current') &&
                    ...
                    _.get('preloading') &&
                      t.each([h(-1), h(1)], function () {
                        ...
                        h &&
                          s(o, h) &&
                          ((h = l(o, h)), (e.createElement('img').src = h));
                      }))
                  : O.hide(),
                _.get('iframe')
          ...
          ? ((i = e.extend({}, o, i || {})),
            ...
            this.each(function () {
              function o() {
                ...
                o
                  ? ((0 === (t = u.getBoundingClientRect().width) ||
                      'number' != typeof t) &&
                      (t = parseFloat(o.width)),
                    e.each(
                      [
                        'paddingLeft',
                        'paddingRight',
              ...
              function s() {
                ...
                if (
                  ...
                  (a.id = i.id),
                  (d = parseFloat(p.css('maxHeight'))),
                  e.each(n, function (e, t) {
                    s[t] = p.css(t);
                  }),
                  e(a).css(s).attr('wrap', p.attr('wrap')),
                  o(),
                  window.chrome)
                ) {
                  var r = u.style.width;
              ...
              p.data('autosize') ||
                ...
                (c = Math.max(
                  parseFloat(p.css('minHeight')) - w || 0,
                  p.height()
                )),
                p.css({
                  overflow: 'hidden',
                ...
                !1 !== i.resizeDelay && e(window).on('resize.autosize', l),
    ...
    if (0 == arguments.length) {
      ...
      if (document.selection) {
        if ((t.focus(), n)) {
          ...
          return (
            (r = document.body.createTextRange()).moveToElementText(t),
        ...
        : document.body.createTextRange &&
          (n
            ? ((c = document.body.createTextRange()).moveToElementText(t),
              ...
              c.collapse(!0),
              c.select())
            : ((c = t.createTextRange()).move('character', e), c.select())),
      n || t.focus(),
      e
    );
  }),
            ...
            (s.sc = e(
              ...
              s.on('keydown.autocomplete', function (t) {
                ...
                if ((40 == t.which || 38 == t.which) && s.sc.html())
                  return (
                    (c = e('.autocomplete-suggestion.selected', s.sc)).length
                      ? (a =
                          40 == t.which
                            ? c.next('.autocomplete-suggestion')
                            : c.prev('.autocomplete-suggestion')).length
  ...
  (function (t) {
    function e(t, a, r, n) {
      function o(t) {
        (r.maxRows && d > r.maxRows) || (r.truncate && t && d > 1)
          ? (w[g][0].style.display = 'none')
          : ((w[g][0].style.width = l + 'px'),
            (w[g][0].style.height = u + 'px'),
            (w[g][0].style.display = 'block'));
      }
      var g,
        l,
        s = 1,
      ...
      for (f || (f = t.width() - 2), i = 0; i < a.length; i++)
        if ((w.push(a[i]), (c += a[i][2] + r.margin) >= f)) {
          ...
          // console.log(f, w.length, r.margin, c);
          for (
            s = (f - m) / (c - m),
              u = Math.ceil(r.rowHeight * s),
              exact_w = 0,
              g = 0;
            g < w.length;
            g++
            ...
            (l = Math.ceil(w[g][2] * s)),
              // console.log(i, g, l, w[g][4]),
              (exact_w += l + r.margin),
              exact_w > f &&
                (l -= exact_w - f) &&
                console.log(`i:${i},g:${g},l:${l},f:${f},exact_w:${exact_w}`),
              o();
          (w = []), (c = 0), d++;
        }
    ...
    t.fn.flexImages = function (a) {
      ...
      return this.each(function () {
        ...
        for (
          i.margin =
            (parseInt(h.marginLeft) || 0) +
            (parseInt(h.marginRight) || 0) +
            (Math.round(parseFloat(h.borderLeftWidth)) || 0) +
            (Math.round(parseFloat(h.borderRightWidth)) || 0),
            j = 0;
          j < r.length;
          j++
        ) {
        ...
        e(a, n, i),
          t(window).off('resize.flexImages'),
          t(window).on('resize.flexImages', function () {
            e(a, n, i);
          }),
          a.data('flex-t', o);
      });
  ...
  (function (t) {
    t.fn.unveil = function (i) {
      ...
      return (
        ...
        r.on('resize.unveil lookup.unveil', e),
        window.addEventListener(
          'scroll',
          e.bind(window),
          !!window.supportsPassive && { passive: !0 }
        ),
        e(),
        this
      );
...
function setCookie(k, v, d, s) {
  var o = new Date();
  o.setTime(o.getTime() + 864e5 * d + 1e3 * (s || 0)),
...
function wopen(url, w, h, target) {
  ...
  var left =
      (window.screenLeft ? window.screenLeft : window.screenX) + ww / 2 - w / 2,
    top =
...
!(function (d) {
  ...
  (window.linkify = (function () {
    ...
    return function (u, D) {
      D = D || {};
      for (
        var w, t, y, p, r, C, B, o, q, A, z, x, v = '', s = [];
        (w = a.exec(u));

      )
        if (
          ((y = w[0]),
          (B = (C = a.lastIndex) - y.length),
          !/[\/:]/.test(u.charAt(B - 1)))
        ) {
          do {
            (o = y),
              ...
              (z = k[x]) &&
                ...
                (q ? q.length : 0) < (A ? A.length : 0) &&
                  ((y = y.substr(0, y.length - 1)), C--)),
              (y = y.replace(
              ...
              (p =
                (-1 !== p.indexOf('@')
                  ...
                  ? p.indexOf('ftp.')
                    ...
                    : 'ftp://'
                  : 'irc://') + p),
            r != B && (s.push([u.slice(r, B)]), (r = C)),
            s.push([y, p]);
        }
      for (s.push([u.substr(r)]), t = 0; t < s.length; t++)
        (text = s[t][0]),
          (p = s[t][1]),
          (target =
            text.indexOf(window.location.hostname) >= 0
              ? ''
              : 'target="_blank" rel="ugc"'),
          (v += p
            ? '<a ' + target + 'href="' + p + '">' + text + '</a>'
            : text);
      return v || u;
    };
  })()),
  ...
  $('.toggle_mobile_search, #mobile_search_background > .pure-button').on(
    'click touchstart',
    function (e) {
      e.preventDefault(),
  ...
  $('.pure-dropdown>a').click(function (e) {
    var sub = (pure_menu = $(this).parent())
      .toggleClass('pure-menu-open')
      .find('.pure-menu-children')
      .css('top', pure_menu.height())
      .removeClass('narrow_menu vertical_menu')
      .css('width', '');
    sub.outerWidth() > ww && sub.addClass('narrow_menu'),
      (ww < 550 || sub.outerWidth() > ww) &&
        sub
          .removeClass('narrow_menu')
          .addClass('vertical_menu')
          .css('width', ww),
      sub.css('left', pure_menu.width() - sub.outerWidth());
    var left = sub[0].getBoundingClientRect().x;
    return (
      left < 0 && sub.css('left', pure_menu.width() - sub.outerWidth() - left),
      !1
    );
  }),
  $(document).mousedown(function (e) {
    !pure_menu ||
      pure_menu.is(e.target) ||
      pure_menu.has(e.target).length ||
      ($('.pure-dropdown').removeClass('pure-menu-open'), (pure_menu = !1));
  }),
    ...
    xhr: function () {
      ...
      try {
        xhr.upload.addEventListener(
          ...
          function (e) {
            e.lengthComputable &&
              loadingBar.css('width', 2 + (100 * e.loaded) / e.total + '%');
          },
          !1
        ),
...
function confirm_action(el) {
  var confirm_text = el.data('confirm'),
    prompt_text = el.data('confirm-prompt');
  if (null == confirm_text) return !0;
  if ((confirm_text || (confirm_text = I18N.delete), prompt_text)) {
    if (
      ((user_input = prompt(
        confirm_text + '\n\nType "' + prompt_text + '" to confirm:'
      )),
      null == user_input)
    )
      return !1;
    if (user_input != prompt_text)
      return alert('Incorrect confirmation - action aborted.'), !1;
  } else if (!confirm(confirm_text)) return !1;
  return !0;
}
$.extend($.colorbox.settings, cboxOptions),
  ...
  $(document).on(
    'click',
    'a[data-confirm]:not(.ajax, .modal, .remove_link)',
    function (e) {
      return confirm_action($(this));
    }
  ),
      ...
      confirm_action(that) &&
        $.get(that.data('href') || this.href, function (re) {
          'script:' == re.substring(0, 7)
            ? eval(re.substring(7))
            : (that.data('w') &&
                ($.colorbox.settings.maxWidth = that.data('w')),
              $.colorbox({
                html: re,
                ...
                onComplete: function () {
                  setTimeout(resized, 100),
                    $('#cboxContent h6').prepend(
                      '<a onclick="$.colorbox.close();">×</a>'
                    );
                }
              }));
        }),
    ...
    return (
      confirm_action(link) &&
        ...
        $.post(this.href || $(this).data('href'), function (re) {
          'script:' == re.substring(0, 7)
            ? eval(re.substring(7))
            : (link.data('target') ? $(link.data('target')) : link).html(re),
            'false' != link.data('resized') && resized();
        })),
      !1
    );
  }),
  ...
  $(document).on('click', '.tab_menu li', function (e) {
    return (
      $(this).siblings().removeClass('selected').end().addClass('selected'), !1
    );
  }),
...
function flexVideoGrid(el, rowHeight, maxRows, truncate) {
  ...
  el.flexImages({ rowHeight: rowHeight, maxRows: maxRows, truncate: truncate })
    .find('.media')
    .hover(
      function () {
        (hover_media = $(this)),
          (hover_media_to = setTimeout(function () {
            ...
            hover_media.prepend(
              '<video style="display:none" onloadeddata="$(this).addClass(\'playing\').show();" autoplay muted loop><source type="video/mp4" src="' +
                mp4 +
                '">' +
                (hover_media.data('webm')
...
function show_message(text, msg_class, t, prepend) {
  $('.message_box').remove();
  var box = $(
    '<div class="message_box" onclick="$(this).remove();"><span style="opacity:.8;float:right;margin-right:8px;cursor:pointer;font-size:20px;line-height:1">×</span>' +
      text +
      '</div>'
  );
  msg_class && box.addClass(msg_class),
    prepend
...
if (
  ($(document).on('click', '.dd_box', function () {
    ...
    if ((dd_box = button.next()).is(':visible')) dd_box.hide(), (dd_box = !1);
      ...
      if (
        ((button.data('left') ||
          (button.offset().left + dd_box.outerWidth() > ww &&
            button.offset().left + button.outerWidth() - dd_box.outerWidth() >
              0)) &&
          (l += button.outerWidth() - dd_box.outerWidth()),
        button.data('up') ||
          (button.offset().top + button.outerHeight() + dd_box.outerHeight() >
            $(document).scrollTop() + wh &&
            button.offset().top - dd_box.outerHeight() > 0))
      )
  ...
  $(document).click(function (e) {
    !dd_box ||
      dd_box.is(e.target) ||
      dd_box.has(e.target).length ||
      (dd_box.hide(), (dd_box = !1));
  }),
  $(function () {
    resized();
    var s = '',
    ...
    ('/xmin/' != loc.substring(0, 5) && '/api/' != loc.substring(0, 5)) ||
      (loc = '/'),
      '/' == loc[3] && (loc = loc.substr(3, 500)),
      qs && (loc += qs);
    for (var i = 0; i < LANGS.length; i++)
      s +=
        "<a onmousedown=\"setCookie('lang', '" +
        LANGS[i][0] +
        '\', 3650);" href="' +
        ('en' != LANGS[i][0] ? '/' + LANGS[i][0] : '') +
        loc +
        '">' +
        LANGS[i][1] +
        '</a>';
    if (
      ($('.language_menu+div').html(s),
      !getCookie('lang') && browser_lang && browser_lang != LANG)
    ) {
      s = '';
      for (i = 0; i < LANGS.length; i++)
        LANGS[i][0] == browser_lang || LANGS[i][0] == LANG
          ? (s +=
              '<a style="margin-right:15px" onmousedown="setCookie(\'lang\', \'' +
              LANGS[i][0] +
              '\', 3650);" href="' +
              ('en' != LANGS[i][0] ? '/' + LANGS[i][0] : '') +
              loc +
          ...
          : (s2 +=
              ...
              '</a>');
      $('body').append(
        '<div class="message_box info" style="top:auto;bottom:0;margin:0;"><span style="margin-right:15px"><img class="hide-xs" src="/static/img/language_fff.svg" style="height:16px;position:relative;top:3px"> Choose your language:</span>' +
          s +
          '<a class="dd_box menu language_menu">More &rarr;</a><div>' +
          s2 +
          '</div></div>'
      );
    }
    $('.media_search').submit(function () {
      ...
      setTimeout(function () {
        'ontouchstart' in window ||
          ...
          $(document).scrollTop() ||
          $('[data-autofocus]').last().focus();
      }, 250),
      ~$.inArray(LANG, ['de', 'en', 'es', 'fr', 'it', 'ja', 'ko', 'pt']) &&
              ...
              ac_xhr = $.ajax({
                ...
                data: JSON.stringify({
                  suggest: {
                    search_term: {
                      prefix: term,
                      completion: { field: 'suggest_' + LANG, size: 5 }
                    }
                  }
                }),
                success: function (re) {
      ...
      $(document).on('click', '.translate', function () {
        return wopen(
          'http://translate.google.de/#auto|' +
            LANG +
            '|' +
            encodeURIComponent($($(this).data('el')).text().substring(0, 999)),
          800,
          500,
          'translate'
        );
      ...
      $('.media_list').length
        ? ($('#paginator_clone').html($('.paginator').clone()),
          $('.flex_grid.video').length
            ? (flexVideoGrid(
                $('.flex_grid.video.search_results'),
                280,
                0,
                !1,
                ''
              ),
              $('.flex_grid.video.affil_videos').each(function () {
                flexVideoGrid(
                  $(this),
                  parseInt($(this).data('rowHeight')) || 280,
                  parseInt($(this).data('rows')) || 1,
                  !1
                );
              }))
        ...
        ? ($('.copy_to_clipboard').click(function () {
          ...
          $('.dl_btn, .view_btn').click(function () {
            dl_menu &&
              dl_menu.is(':visible') &&
              !$('.dl_btn').hasClass('modal') &&
              (setTimeout(function () {
                $('.canva-ad-container').width(
                  $('.attribution_field').width() - 4
                );
              }, 40),
              $('#say_thanks_overlay').fadeIn(),
        ...
        ? ($('.copy_to_clipboard').click(function () {
          ...
          flexVideoGrid($('.flex_grid.video.related_videos'), 240, 4, !0),
          flexVideoGrid($('.flex_grid.video.affil_videos'), 240, 2, !0))
        : $('.signup_form.new').length &&
          $.get(LANG_URL_PREFIX + '/accounts/register/ets/', function (ts) {
      ...
      $('#media_show').length &&
        ...
        $('.download_menu span').on('click contextmenu', function () {
          return (
            (dl_menu = $(this).next()).is(':visible')
              ? dl_menu.hide()
              : (wh - dl_menu.prev().offset().top + $(document).scrollTop() >
                250
                  ? dl_menu.removeClass('ne').addClass('se')
                  : dl_menu.removeClass('se').addClass('ne'),
                dl_menu
                  .width(dl_menu.prev().width() + 22)
                  .show()
                  .find('.selected input')
                  .prop('checked', !0)),
            !1
        ...
        $(document).click(function (e) {
          !dl_menu ||
            dl_menu.is(e.target) ||
            dl_menu.has(e.target).length ||
            (dl_menu.hide(), (dl_menu = null));
        }),
        $('.download_menu tr').click(function () {
          $('.download_menu tr').removeClass('selected');
          var input = $(this).find('input').eq(0);
          input.prop('checked', !0),
            $('.download_menu [value="' + input.val() + '"]')
              .closest('tr')
              .addClass('selected');
          var file = input.val(),
          ...
          file.indexOf('/') < 0 &&
            (file =
              LANG_URL_PREFIX +
              '/' +
              $('.download_menu').data('type') +
              '/download/' +
              file),
            (show_captcha && perm) || (!auth_user && 'auth' == perm)
    ...
    window.location.host.indexOf('safesearch') > -1 || 'permanent' == g_rated
      ? ((g_rated = !0),
        $('.toggle_g_rated')
          .attr('disabled', !0)
          .parent()
          .parent()
          .attr('title', 'SafeSearch is enabled and locked.')
          .click(function () {
            alert(this.title);
          }))
      : $(document).on('click', '.toggle_g_rated', function () {
          setCookie(
            'g_rated',
            (g_rated = $(this).is(':checked')) ? 1 : '',
            3650
          ),
            $('.toggle_g_rated').prop('checked', g_rated);
        }),
      g_rated
        ? $('.toggle_g_rated').prop('checked', !0)
        : '' != g_rated &&
          ((nsfw_placeholder =
            ...
            I18N.adult_content +
            '</span>                    <span style="font-size:14px;color:#aaa">' +
            I18N.safesearch +
            '</span>                </span>            </b>'),
  ...
  var cookies_hint = {
    de:
      'Um Dein Nutzererlebnis zu verbessern, setzen wir <a href="/service/privacy/#cookies">Cookies</a> ein.'
  };
  $(
    '<div class="message_box info" style="position:relative;margin:0;">' +
      (cookies_hint[LANG] || cookies_hint.en) +
      ' &nbsp; <span class="pure-button button-sm" onclick="setCookie(\'cookies_ok\', 1, 365*5);$(\'.message_box\').remove();">OK</span></div>'
  ).prependTo('body');
}
function password_strength(password) {
  var val = password.value,
    strength = 0;
  val.length >= 8
    ? ((document.getElementById('eight-char').className = 'pixabay-green'),
      (strength += 1))
    : (document.getElementById('eight-char').className = ''),
    null != val.match(/\d+/g)
      ? ((strength += 1),
        (document.getElementById('numerics').className = 'pixabay-green'))
      : (document.getElementById('numerics').className = ''),
    /[\s~`!@#$%\^&*+=\-\[\]\\';,/{}|\\":<>\?()\._]/g.test(val)
      ? ((strength += 1),
        (document.getElementById('special-char').className = 'pixabay-green'))
      : (document.getElementById('special-char').className = ''),
    /[a-z]/.test(val) && /[A-Z]/.test(val)
      ? ((strength += 1),
        (document.getElementById('upper-case').className = 'pixabay-green'))
      : (document.getElementById('upper-case').className = '');
  var result = ['very-poor', 'poor', 'moderate', 'moderate', 'strong'][
      strength
    ],
    meter = document.getElementById('password-strength-inner'),
    text = document.getElementById('password-strength-text'),
    suggestions = document.getElementById('password-suggestion-box');
  '' !== val
    ? ((meter.className = result),
      (text.className = result),
      (text.innerHTML = 'Strength: ' + result),
      (suggestions.className = 'show'),
      val.length >= 8 && val.match(/\d+/g)
        ? (document.getElementsByClassName(
            'sign_up_button pure-button button-green'
          )[0].disabled = !1)
        : (document.getElementsByClassName(
            'sign_up_button pure-button button-green'
          )[0].disabled = !0))
...
$('.linkify.ucg > a').attr('rel', 'nofollow'),
  $(
    '[data-href*="/accounts/favorite/"] *, [data-href*="/images/like/"] *, [data-href*="/videos/like/"] *'
  ...
  (function () {
    ...
    $(function () {
      getClicks().filter(clickInWindow(Date.now())).length >= 3
        ? DEBUG
          ? console.log('Getty ads not hidden, because debug mode is enabled.')
          : ($('.getty-item').hide(), $('.external-media').hide())
        : $(document).on('click', '.getty-item a', function (e) {
            const now = Date.now();
            let clicks = getClicks().filter(clickInWindow(now));
            if (clicks.length >= 3)
              return (
                $('.getty-item')
                  .find('.ua-api-ad-getty')
                  .removeClass('ua-api-ad-getty'),
                void $('.getty-item')
                  .find('.getty-banner-link')
                  .removeClass('getty-banner-link')
              );
            var url;
            clicks.push(now),
              (function (clicks) {
  ...
  $('#register_password_field').on('change paste keyup', function () {
    password_strength($(this)[0]);
  }),
  $('#register_password_field').each(function (i, elem) {
    password_strength(elem);
  });
